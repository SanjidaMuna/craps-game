...
function won() {
    againRoll = 3;
    document.getElementById("notice").innerHTML = "you won."; // set the notice to won game
    document.getElementById("rollButton").disabled = true; // disable the roll button
    document.getElementById("rollButton").innerHTML = "<img src='you_win.png' />"; // change the text of the roll button
...
function lost() {
	...
	document.getElementById("rollButton").disabled = true; // disable the roll button
    document.getElementById("rollButton").innerHTML = "<img src='you_lose.png' />"; // change the text of the roll button
    document.getElementById("replay").style.visibility = "visible"; // show the replay button
